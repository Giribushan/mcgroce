...
def get_extreams(image):
    ...
    #Before we can find extreme points along a contour, it is important to understand that a contour is simply a NumPy #array of (x, y)-coordinates. Therefore, we can leverage #NumPy functions to help us find the extreme coordinates.
